    ...
    <div className="flex">
      ...
      <div class="flex-initial w-7/12 ml-5">
        <div className="flex flex-col">
          ...
          <div className="mx-5">
            <p className="font-sn italic hover:not-italic leading-5">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur
              quam placeat necessitatibus eum doloremque asperiores totam rem
              non, modi delectus quos doloribus molestiae rerum veritatis.
              Veniam commodi illum fugiat fugit!
            </p>
          </div>
